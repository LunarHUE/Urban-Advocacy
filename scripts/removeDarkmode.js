...
const configFiles = [
  {
    filePath: "urban-advocacy/tailwind.config.js",
    patterns: ["darkmode:\\s*{[^}]*},", 'darkMode:\\s*"class",'],
  },
  {
    filePath: "urban-advocacy/data/theme.json",
...
const deleteAssetList = [
  "urban-advocacy/assets/images/logo-darkmode.png",
...
function removeDarkMode(configFile) {
  ...
  if (filePath === "urban-advocacy/tailwind.config.js") {
    removeDarkModeFromFiles(filePath, patterns);
  } else {
